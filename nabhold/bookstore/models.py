...
class Book(models.Model):
    ...
    bookshot = models.ImageField(upload_to='book_bookshots', blank=True, null=True)
...
class Author(models.Model):
    ...
    salutation = models.CharField(max_length=10, choices=SALUTATION, blank=True, default='MR', help_text='Your prefered title for salutation')
